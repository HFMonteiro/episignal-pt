# Episomer integration contract

This project does not vendor or execute the ECDC Episomer package yet. The current integration is a browser-side contract and review surface for aggregated digital epidemic intelligence signals.
...
Episomer signals are digital epidemic intelligence signals. They must not be treated as notified cases, incidence numerators, denominators, or outbreak confirmation.
